(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))o(l);new MutationObserver(l=>{for(const n of l)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(l){const n={};return l.integrity&&(n.integrity=l.integrity),l.referrerPolicy&&(n.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?n.credentials="include":l.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(l){if(l.ep)return;l.ep=!0;const n=a(l);fetch(l.href,n)}})();const $={};function A(t,e){$[t]=e}function re(t){window.location.hash=t}function Y(){var l,n;const t=window.location.hash.slice(1)||"/",e=t.match(/^\/domain\/([^?]+)/);if(e){(l=$["/domain/:id"])==null||l.call($,{id:decodeURIComponent(e[1])});return}const[a,o]=t.split("?");(n=$[a])==null||n.call($,Object.fromEntries(new URLSearchParams(o||"")))}function de(){window.addEventListener("hashchange",Y),Y()}let z=null;async function G(){if(z)return z;const t=await fetch("/cb-college-physics/domains/catalog.json");if(!t.ok)throw new Error(`Failed to load catalog: ${t.status}`);return z=await t.json(),z}const Z={en:{"app.title":"ConceptBook","app.tagline":"Explore knowledge through concept graphs","nav.graph":"Graph","nav.content":"Content","nav.about":"About","nav.settings":"Settings","home.subtitle":"Choose a domain to explore","home.filter.all":"All","home.filter.level":"Level","card.nodes":"nodes","card.edges":"edges","card.explore":"Explore Concept-Graph","card.read":"Read book","domain.back":"← Back","domain.openFullscreen":"Open fullscreen","about.title":"About concept-book",loading:"Loading…"}};let X=localStorage.getItem("cb-lang")||"en";function T(t){return(Z[X]||Z.en)[t]??t}function pe(t){X=t,localStorage.setItem("cb-lang",t)}function oe(){return X}function ue(t){const e=document.createElement("article");e.className="cb-card";const a=(t.tags||[]).map(o=>`<span class="cb-tag" data-tag="${o}">${o}</span>`).join("");return e.innerHTML=`
  ...
  `,e.querySelector(".js-explore").addEventListener("click",()=>{re(`/domain/${t.id}`)}),e}const ae=[{code:"en",label:"English"},{code:"zh",label:"中文 (Chinese)"},{code:"es",label:"Español (Spanish)"},{code:"fr",label:"Français (French)"},{code:"de",label:"Deutsch (German)"},{code:"ja",label:"日本語 (Japanese)"},{code:"ko",label:"한국어 (Korean)"},{code:"pt",label:"Português (Portuguese)"},{code:"ar",label:"العربية (Arabic)"},{code:"hi",label:"हिन्दी (Hindi)"}];function me(){const t=document.createElement("select");t.className="cb-lang-picker",t.title="Content language";const e=oe();return ae.forEach(({code:a,label:o})=>{const l=document.createElement("option");l.value=a,l.textContent=o,a===e&&(l.selected=!0),t.appendChild(l)}),t.addEventListener("change",()=>pe(t.value)),t}function P({domainName:t=""}={}){const e=document.createElement("header");e.className="cb-header";const a=document.createElement("div");a.className="cb-header__top";const o=document.createElement("a");if(o.className="cb-header__logo",o.href="#/",o.textContent=T("app.title"),a.appendChild(o),t){const s=document.createElement("span");s.className="cb-header__sep",s.textContent="›",a.appendChild(s);const h=document.createElement("span");h.className="cb-header__domain",h.textContent=t,a.appendChild(h)}const l=document.createElement("span");l.className="cb-header__spacer",a.appendChild(l);const n=document.createElement("nav");n.className="cb-header__nav";const r=document.createElement("a");r.href="#/graph",r.textContent=T("nav.graph"),n.appendChild(r);const m=document.createElement("a");m.href="#/book",m.textContent=T("nav.content"),n.appendChild(m);const c=document.createElement("a");c.href="#/settings",c.textContent=T("nav.settings"),n.appendChild(c),n.appendChild(me());const d=document.createElement("a");return d.href="#/about",d.textContent=T("nav.about"),n.appendChild(d),a.appendChild(n),e.appendChild(a),e}async function be(t){t.innerHTML="",t.appendChild(P());const e=document.createElement("main");e.className="cb-home",e.innerHTML=`<p class="cb-loading">${T("loading")}</p>`,t.appendChild(e);let a;try{a=await G()}catch(c){e.innerHTML=`<p class="cb-error">Could not load domains. ${c.message}</p>`;return}const o=[...new Set(a.flatMap(c=>c.tags))].sort(),l=["intro","core","college","research"];let n="all",r="all";function m(){let c=a;n!=="all"&&(c=c.filter(s=>s.tags.includes(n))),r!=="all"&&(c=c.filter(s=>s.default_level===r)),e.innerHTML=`
    ...
    `;const d=e.querySelector(".cb-card-grid");c.forEach(s=>d.appendChild(ue(s))),e.querySelectorAll(".cb-filter-btn[data-tag]").forEach(s=>{s.addEventListener("click",()=>{n=s.dataset.tag,m()})}),e.querySelector("#cb-level-filter").addEventListener("change",s=>{r=s.target.value,m()})}m()}const fe=[{code:"en",label:"English"},{code:"zh",label:"中文"},{code:"es",label:"Español"},{code:"fr",label:"Français"},{code:"de",label:"Deutsch"},{code:"ja",label:"日本語"},{code:"ko",label:"한국어"},{code:"pt",label:"Português"},{code:"ar",label:"العربية"},{code:"hi",label:"हिन्दी"}],he=["intro","core","college","research"];function ge(t,e){const a={};(e||[]).forEach(l=>{if(!l.name||!l.file)return;const n=a[l.name];(!n||n.model&&!l.model)&&(a[l.name]={file:l.file,model:l.model})});const o={};return Object.keys(a).forEach(l=>{o[l]=`/cb-college-physics/domains/${t}/${a[l].file}`}),o}function ve(t,{level:e="intro",lang:a="en"}={}){const{id:o,books:l=[],generated_concepts:n=[],capstone:r}=t,m=document.createElement("div");m.className="cb-graph-viewer";const c=document.createElement("iframe");return c.className="cb-graph-viewer__frame",c.src=`/cb-college-physics/domains/${o}/output/graph.html`,c.title=`${o} concept graph`,c.setAttribute("allowfullscreen",""),c.addEventListener("load",()=>{var d;try{const s=c.contentWindow;if(!s)return;s.eval("window.__cb_RAW = RAW; window.__cb_nodeIndex = nodeIndex"),s.__cb_CONCEPTS_BASE=`/cb-college-physics/domains/${o}/output/${e}.${a}/html/`,s.__cb_CONCEPT_URLS=ge(o,n);const h=(((d=s.__cb_RAW)==null?void 0:d.nodes)||[]).map(b=>({id:b.id,label:b.label,kind:b.kind,tier:b.tier??0}));window.dispatchEvent(new CustomEvent("cb:graphLoaded",{detail:{concepts:h}}));const _=s.handleSelect;s.handleSelect=function(b){var p;_.call(s,b);const v=(p=s.__cb_nodeIndex)==null?void 0:p[b];v&&window.dispatchEvent(new CustomEvent("cb:nodeSelected",{detail:{nodeId:b,node:v}}))},ye(s,c.contentDocument),xe(s,c.contentDocument,o,l,n,e,a),_e(s,c.contentDocument,o,r,e,a,l)}catch{}}),m.appendChild(c),m.selectNode=d=>{var s,h;try{(h=(s=c.contentWindow)==null?void 0:s.selectNode)==null||h.call(s,d)}catch{}},m}function ye(t,e){if(e.querySelector("#cb-sidebar-theme"))return;const a=e.createElement("style");a.id="cb-sidebar-theme",a.textContent=`
  ...
  `:"",g=e.createElement("div");g.id="cb-read",g.style.cssText=le,g.innerHTML=`
    ...
    ${p}
    ${u}
  `,m.insertAdjacentElement("afterend",g);function x(i,f){i.textContent=f,i.style.display="block"}async function y(i){try{const f=await fetch(i);if(!f.ok)return!1;const C=await f.text();return C.includes("spl-credit")||C.includes("Generated by")}catch{return!1}}function E(i,f){const C=`/cb-college-physics/domains/${a}/${i}`;y(C).then(L=>{L?window.location.hash=`/book?domain=${a}&file=${encodeURIComponent(i)}`:x(f,"No content available for this level/language combination.")})}if(e.addEventListener("cb:settings-change",({detail:{level:i,lang:f}})=>{g.querySelectorAll("#cb-book-sel option[data-orig]").forEach(C=>{C.value=B(C.dataset.orig,i,f,C.dataset.model)}),g.querySelectorAll("#cb-cpt-sel option[data-orig]").forEach(C=>{C.value=B(C.dataset.orig,i,f,C.dataset.model)}),e.querySelector("#cb-book-warn")&&(e.querySelector("#cb-book-warn").style.display="none"),e.querySelector("#cb-cpt-warn")&&(e.querySelector("#cb-cpt-warn").style.display="none")}),c.length>0){const i=g.querySelector("#cb-book-sel"),f=g.querySelector("#cb-book-btn"),C=g.querySelector("#cb-book-warn");i.addEventListener("change",()=>{f.disabled=!i.value,f.style.cssText=i.value?V:j,C.style.display="none"}),f.addEventListener("click",()=>{i.value&&E(i.value,C)})}if(d.length>0){const i=g.querySelector("#cb-cpt-sel"),f=g.querySelector("#cb-cpt-btn"),C=g.querySelector("#cb-cpt-warn");i.addEventListener("change",()=>{f.disabled=!i.value,f.style.cssText=i.value?V:j,C.style.display="none"}),f.addEventListener("click",()=>{i.value&&E(i.value,C)})}}function _e(t,e,a,o,l,n,r=[]){var M;const m=e.querySelector("#path-header");if(!m||e.querySelector("#cb-gen"))return;const c=["width:100%","padding:5px 8px","border:1px solid rgba(255,255,255,0.3)","border-radius:5px","background:#fff","color:#2a2a2a","font-size:12px","margin-bottom:6px","font-family:system-ui,sans-serif"].join(";"),d=e.createElement("div");d.id="cb-gen",d.style.cssText=le,d.innerHTML=`
  ...
  `,m.insertAdjacentElement("afterend",d);const s=d.querySelector("#cb-target-sel"),h=d.querySelector("#cb-model-sel"),_=d.querySelector("#cb-level-sel"),b=d.querySelector("#cb-lang-sel"),v=d.querySelector("#cb-skip-cache"),p=d.querySelector("#cb-gen-btn"),u=d.querySelector("#cb-pdf-btn"),g=d.querySelector("#cb-pdf-result"),x=d.querySelector("#cb-gen-log"),y=d.querySelector("#cb-gen-copy");function E(){e.dispatchEvent(new CustomEvent("cb:settings-change",{detail:{level:_.value,lang:b.value}}))}_.addEventListener("change",E),b.addEventListener("change",E),y.addEventListener("click",()=>{navigator.clipboard.writeText(x.textContent).then(()=>{y.textContent="Copied!",setTimeout(()=>{y.textContent="Copy"},1500)})});const i=`cb_gen_target_${a}`,f=(((M=t.__cb_RAW)==null?void 0:M.nodes)||[]).filter(k=>k.kind!=="primitive").sort((k,w)=>k.label.localeCompare(w.label)),C=sessionStorage.getItem(i),L=C&&f.some(k=>k.id===C)?C:o;f.forEach(k=>{const w=e.createElement("option");w.value=k.id,w.textContent=k.label,k.id===L&&(w.selected=!0),s.appendChild(w)}),s.value&&(p.disabled=!1,u.disabled=!1),s.addEventListener("change",()=>{s.value&&sessionStorage.setItem(i,s.value),p.disabled=!s.value,u.disabled=!s.value,u.textContent="PDF",u.style.background="#16a34a",g.style.display="none",g.innerHTML=""}),u.addEventListener("click",async()=>{const k=s.value;if(!k)return;const w=_.value,F=b.value;u.disabled=!0,u.textContent="Generating…",u.style.background="#ea580c";try{const I=`/api/pdf?domain=${encodeURIComponent(a)}&target=${encodeURIComponent(k)}&level=${encodeURIComponent(w)}&language=${encodeURIComponent(F)}`,O=await fetch(I),R=await O.json();if(!O.ok)throw new Error(R.detail||"PDF generation failed");const N=`/cb-college-physics/domains/${a}/${R.file}`;u.textContent="PDF ✓",u.disabled=!1,g.innerHTML=`
        <a href="${N}" download
      ...
      `,g.style.display="flex"}catch(I){u.textContent="Error",u.style.background="#dc2626",u.title=I.message,setTimeout(()=>{u.textContent="PDF",u.style.background="#16a34a",u.disabled=!1},3e3)}}),p.addEventListener("click",()=>{const k=s.value;if(!k)return;sessionStorage.setItem(i,k);const w=h.value,F=_.value,I=b.value,O=v.checked;p.disabled=!0,p.textContent="Generating…",p.style.background="#ea580c",x.style.display="block",y.style.display="block",x.textContent=`▶ target: ${k}  model: ${w}
`;const R=`/api/generate?domain=${encodeURIComponent(a)}&target=${encodeURIComponent(k)}&level=${encodeURIComponent(F)}&language=${encodeURIComponent(I)}&model=${encodeURIComponent(w)}${O?"&skip_cache=true":""}`,S=new t.EventSource(R);S.addEventListener("log",N=>{const{message:ie}=JSON.parse(N.data);x.textContent+=ie+`
`,x.scrollTop=x.scrollHeight}),S.addEventListener("done",()=>{S.close(),x.textContent+=`
✓ Done — reloading…`,setTimeout(()=>t.parent.location.reload(),1200)}),S.addEventListener("gen_error",N=>{S.close(),x.textContent+=`
✗ ${JSON.parse(N.data).message}`,p.disabled=!1,p.textContent="Retry",p.style.background="#dc2626"}),S.onerror=()=>{S.readyState!==t.EventSource.CLOSED&&(S.close(),x.textContent+=`
✗ API not reachable.
  ...
  </body></html>`}function J(t,e,a){const o=document.createElement("select");return o.className=a,t.forEach(({value:l,label:n})=>{const r=document.createElement("option");r.value=l,r.textContent=n,l===e&&(r.selected=!0),o.appendChild(r)}),o}function qe(t,e,a){const o=document.createElement("div");o.className="cb-book-pane__controls";const l=J(we,e.model,"cb-book-pane__select");l.title="Model",l.addEventListener("change",()=>a("model",l.value)),o.appendChild(l);const n=J(Le.map(m=>({value:m,label:m.charAt(0).toUpperCase()+m.slice(1)})),e.level,"cb-book-pane__select");n.title="Level",n.addEventListener("change",()=>a("level",n.value)),o.appendChild(n);const r=J(ae.map(m=>({value:m.code,label:m.label})),e.lang,"cb-book-pane__select");return r.title="Language",r.addEventListener("change",()=>a("lang",r.value)),o.appendChild(r),o}function Ae(t,e,{onConceptClick:a}){t.innerHTML="";try{const o=e.contentDocument,l=o==null?void 0:o.querySelector("nav.toc");if(!l){t.innerHTML='<div style="color:#90b4e8;font-size:11px;padding:4px 0">No table of contents for this page.</div>';return}const n=document.createElement("div");n.style.cssText="font-size:.75rem;letter-spacing:.1em;text-transform:uppercase;color:#90b4e8;margin-bottom:14px;font-family:system-ui,sans-serif;font-weight:700",n.textContent="Contents",t.appendChild(n);const r=l.querySelector("ol");if(r){const c=document.createElement("ol");c.style.cssText="list-style:decimal inside;padding:0;margin:0;flex:1",r.querySelectorAll("li").forEach(d=>{const s=d.querySelector("a");if(!s)return;const h=d.classList.contains("toc-target"),_=document.createElement("li");_.style.cssText=`margin-bottom:7px;font-size:.85rem;line-height:1.4;font-family:system-ui,sans-serif${h?";font-weight:700":""}`;const b=document.createElement("a");b.textContent=s.textContent,b.href="#",b.style.cssText=`text-decoration:none;color:${h?"#fff":"#a8c8f0"}`,b.addEventListener("mouseover",()=>{b.style.color="#fff"}),b.addEventListener("mouseout",()=>{b.style.color=h?"#fff":"#a8c8f0"}),b.addEventListener("click",v=>{v.preventDefault(),a(s.getAttribute("href"))}),_.appendChild(b),c.appendChild(_)}),t.appendChild(c)}if(l.querySelector(".spl-credit")){const c=document.createElement("div");c.style.cssText="margin-top:auto;padding-top:14px;border-top:1px solid rgba(255,255,255,0.15);font-size:11px;color:#90b4e8;font-family:system-ui,sans-serif",c.textContent="Generated by SPL",t.appendChild(c)}}catch{}}function He(t){try{const e=t.contentDocument;if(!e)return;const a=e.createElement("style");a.textContent="nav.toc { display: none !important; } .page { grid-template-columns: 1fr !important; } h1.book-title + section > h2:first-child { display: none !important; }",e.head.appendChild(a)}catch{}}async function Ie(){try{return(await G()).map(e=>e.id)}catch{return[]}}async function Pe(t){try{const a=(await G()).find(n=>n.id===t)??{},o=(a.books||[]).map(n=>({file:n.file,label:n.target.replace(/_/g," ").trim()||n.target,model:n.model||D(n.file)})),l=(a.generated_concepts||[]).map(n=>({file:n.file,label:n.label,model:n.model||D(n.file)}));return Te(t,[...o,...l]),{books:o,concepts:l}}catch{return{books:[],concepts:[]}}}function Oe(t,e){const a=document.createElement("nav");a.className="cb-book-nav";const o=document.createElement("div");o.className="cb-book-nav__title",o.textContent="Concept Books",a.appendChild(o);function l(x){const y=document.createElement("div");return y.className="cb-book-nav__label",y.textContent=x,y}a.appendChild(l("Domain"));const n=document.createElement("select");n.className="cb-book-nav__select",a.appendChild(n),a.appendChild(l("Model"));const r=document.createElement("select");r.className="cb-book-nav__select",r.innerHTML='<option value="">— all —</option>',a.appendChild(r),a.appendChild(l("TOC Index"));const m=document.createElement("select");m.className="cb-book-nav__select",a.appendChild(m),a.appendChild(l("Concept"));const c=document.createElement("select");c.className="cb-book-nav__select",a.appendChild(c);const d=document.createElement("button");d.textContent="Open",d.disabled=!0,d.className="cb-book-nav__open",a.appendChild(d);function s(){d.disabled=!n.value||!m.value&&!c.value}let h=[],_=[];function b(){const x=r.value,y=x?h.filter(i=>!i.model||i.model===x):h,E=x?_.filter(i=>!i.model||i.model===x):_;m.innerHTML='<option value="">Select book…</option>',c.innerHTML='<option value="">Select concept…</option>',y.forEach(i=>{const f=document.createElement("option");f.value=i.file,f.textContent=i.label,i.file===e&&(f.selected=!0),m.appendChild(f)}),E.forEach(i=>{const f=document.createElement("option");f.value=i.file,f.textContent=i.label,i.file===e&&(f.selected=!0),c.appendChild(f)}),s()}async function v(x){m.innerHTML='<option value="">Loading…</option>',c.innerHTML='<option value="">Loading…</option>',r.innerHTML='<option value="">Loading…</option>',s();const{books:y,concepts:E}=await Pe(x);h=y,_=E;const i=new Set;y.forEach(L=>{L.model&&i.add(L.model)}),E.forEach(L=>{L.model&&i.add(L.model)});const f=[...i].sort();r.innerHTML='<option value="">— all —</option>',f.forEach(L=>{const M=document.createElement("option");M.value=L,M.textContent=L,r.appendChild(M)});const C=e?D(e):"";C&&i.has(C)?r.value=C:i.has("sonnet")&&(r.value="sonnet"),b()}async function p(){n.innerHTML='<option value="">Loading…</option>',m.innerHTML='<option value="">—</option>',c.innerHTML='<option value="">—</option>',s();const x=await Ie();n.innerHTML='<option value="">Select domain…</option>',[...x].sort((y,E)=>y.localeCompare(E,"zh")).forEach(y=>{const E=document.createElement("option");E.value=y,E.textContent=y,y===t&&(E.selected=!0),n.appendChild(E)}),n.value?await v(n.value):s()}n.addEventListener("change",()=>{n.value?v(n.value):(m.innerHTML='<option value="">—</option>',c.innerHTML='<option value="">—</option>',r.innerHTML='<option value="">— all —</option>',h=[],_=[],s())}),r.addEventListener("change",b),m.addEventListener("change",()=>{m.value&&(c.value=""),s()}),c.addEventListener("change",()=>{c.value&&(m.value=""),s()}),d.addEventListener("click",()=>{const x=m.value||c.value,y=n.value;x&&y&&(window.location.hash=`/book?domain=${encodeURIComponent(y)}&file=${encodeURIComponent(x)}`)});const u=document.createElement("div");u.style.cssText="border-top:1px solid rgba(255,255,255,0.15);margin:10px 0 8px;flex-shrink:0",a.appendChild(u);const g=document.createElement("div");return g.style.cssText="flex:1;overflow-y:auto;min-height:0;display:flex;flex-direction:column",g.innerHTML='<div style="color:#90b4e8;font-size:11px;padding:4px 0">Open a book to see contents.</div>',a.appendChild(g),a.tocSection=g,p(),a}function Re(t,e){const{domain:a,file:o}=e||{};t.innerHTML="",t.style.cssText="",t.className="cb-book-page",t.appendChild(P());const l=document.createElement("div");l.style.cssText="display:flex;flex:1;overflow:hidden",t.appendChild(l);const n=Oe(a||"",o||"");l.appendChild(n);const r=document.createElement("div");if(r.style.cssText="flex:1;display:flex;overflow:hidden;min-width:0",l.appendChild(r),!a||!o)return;const m=Se(o);let c=o;const d={level:m.level,lang:m.lang,model:D(o)},s=document.createElement("div");s.style.cssText="flex:1;display:flex;flex-direction:column;overflow:hidden;min-width:0",r.appendChild(s),s.appendChild(qe(null,d,(p,u)=>{d[p]=u,v()}));const h=document.createElement("iframe");h.style.cssText="flex:1;width:100%;border:none;display:block",s.appendChild(h);let _=!1;const b=p=>{var u,g;if(p){if(p.startsWith("#")){try{(g=(u=h.contentDocument)==null?void 0:u.querySelector(p))==null||g.scrollIntoView({behavior:"smooth"})}catch{}return}c=c.replace(/[^/]+\.html$/,p),v()}};h.addEventListener("load",()=>{var u,g,x;if(_)return;try{const y=(g=(u=h.contentWindow)==null?void 0:u.location)==null?void 0:g.href;if(y&&!y.startsWith("about:")){const E=decodeURIComponent(y.replace(/.*\/html\//,""));E&&!E.includes("://")&&E!==Q(c)&&(c=c.replace(/[^/]+\.html$/,E))}}catch{}He(h);let p=!1;try{p=!!((x=h.contentDocument)!=null&&x.querySelector("nav.toc"))}catch{}p&&Ae(n.tocSection,h,{onConceptClick:b})});function v(){const p=$e(a,c,d.level,d.lang,d.model);Me(p).then(u=>{_=!u,u?h.src=p:(h.removeAttribute("src"),h.srcdoc=Ne(Q(c),d.model,d.lang,d.level))})}v()}const H=document.getElementById("app");A("/",()=>be(H));A("/about",()=>Ee(H));A("/settings",()=>ke(H));A("/domain/:id",t=>ce(H,t));A("/graph",()=>ce(H,{}));A("/book",t=>Re(H,t));de();
